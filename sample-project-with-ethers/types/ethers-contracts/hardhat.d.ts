...
getContractFactory(name: 'SampleContract', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.SampleContract__factory>

  getContractAt(name: 'Lock', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Lock>
getContractAt(name: 'SampleContract', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.SampleContract>

  deployContract(name: 'Lock', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Lock>
deployContract(name: 'SampleContract', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.SampleContract>

  deployContract(name: 'Lock', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Lock>
deployContract(name: 'SampleContract', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.SampleContract>
